import { BarChart3, CalendarDays, Home, Plus, Target } from "lucide-react";
...
export function MobileNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-budget-border bg-budget-card/95 px-3 pb-3 pt-2 shadow-soft backdrop-blur-xl md:hidden">
