...
export function Dashboard() {
  ...
  const previewGoals = [...activeGoals]
    .slice(0, 2);
        ...
        <section className="mb-4">
          <div className="flex items-start gap-3 rounded-xl border border-budget-border bg-budget-card p-3">
            ...
            <div className="min-w-0 pt-1">
              ...
              <p className="text-sm font-semibold leading-6 text-budget-text/70">{mascotCheckIn.clyde.message}</p>
            </div>
          </div>
        </section>
          ...
          <Card className="p-0">
            <div className="divide-y divide-budget-border">
              {recentTransactions.slice(0, 3).map((transaction) => {
                ...
                return (
                  <div className="flex items-center justify-between gap-3 px-4 py-3" key={transaction.id}>
          ...
          <Card className="p-0">
            <div className="divide-y divide-budget-border">
              {dueDates.slice(0, 2).map((bill) => (
                <div className="flex items-center justify-between gap-3 px-4 py-3" key={bill.id}>
                  <div className="min-w-0">
          ...
          >
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs font-semibold text-budget-text/55">
                Keep savings targets close from the dashboard.
              </p>
            </div>
            <span className="shrink-0 text-sm font-black text-budget-primary">Open</span>
          </Link>
        </section>
          ...
          <Card className="p-0">
            <div className="divide-y divide-budget-border">
              {previewGoals.slice(0, 2).map((goal) => {
                ...
                return (
                  <div className="flex items-center justify-between gap-3 px-4 py-3" key={goal.id}>
                    <div className="min-w-0">
